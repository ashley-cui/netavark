...
The create command takes a partially configured network and fills out the rest of the network config accordingly. 
The create command input is describled in [netavark-create-input.md](netavark-create-input.md). The output of the
